            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.email') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'referral') { ?>
                    <a href="<?php echo $sort_referral; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_referral; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_referral; ?>"><?php echo $column_referral; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['referral']; ?></td>
