...
class ControllerCustomerCustomer extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$referral = json_decode($result['custom_field'], true);

			$data['customers'][] = array(
				'customer_id'    => $result['customer_id'],
				'name'           => $result['name'],
				'email'          => $result['email'],
				'referral'   	 => isset($referral) && isset($referral[1]) ? $referral[1] : "-",
		...
		$data['column_referral'] = $this->language->get('column_referral');
		...
		$data['sort_referral'] = $this->url->link('customer/customer', 'token=' . $this->session->data['token'] . '&sort=sort_referral' . $url, true);
